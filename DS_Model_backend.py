...
ns = """
    ...
    PREFIX d: <http://localhost:3030/DSModel/data/Dental_pain_model>
    """
...
def Pain_present_insert_yes():
    v1 = "Yes"
    conn = pymysql.connect("localhost", "db_test", "111222", "CaseStudy2")
    cur = conn.cursor()
...
def add_data():
    sparql=SPARQLWrapper("http://localhost:3030/DSModel/update")
    sparql.setQuery(ns+"""
    COPY d: to DEFAULT;
        """)
...
def view():
    sparql = SPARQLWrapper("http://localhost:3030/DSModel/query")
    sparql.setQuery(ns+"""
